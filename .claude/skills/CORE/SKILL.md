...
description: |
  ...
  ⚠️  WITHOUT 🎯 COMPLETED LINE → NO VOICE NOTIFICATIONS → USER FRUSTRATION ⚠️

  YOU MUST USE THIS FORMAT FOR EVERY SINGLE RESPONSE - NO EXCEPTIONS

  BEFORE SENDING ANY RESPONSE, VERIFY:
  ✅ Does it have 📋 SUMMARY?
  ✅ Does it have 🔍 ANALYSIS?
  ✅ Does it have ⚡ ACTIONS?
  ✅ Does it have ✅ RESULTS?
  ✅ Does it have 📊 STATUS?
  ✅ Does it have 📁 CAPTURE?
  ✅ Does it have ➡️ NEXT?
  ✅ Does it have 📖 STORY EXPLANATION?
  ✅ Does it have 🎯 COMPLETED? ← THIS ONE DRIVES VOICE - NEVER FORGET

  IF ANY ARE MISSING → REWRITE THE ENTIRE RESPONSE
