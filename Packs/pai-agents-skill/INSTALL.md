...
- **pai-core-install** pack installed (provides skill routing)
- **Optional**: pai-voice-system pack for voice notifications
...
If using pai-voice-system, edit `Traits.yaml` to replace placeholder voice IDs:
