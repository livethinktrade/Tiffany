...
- **pai-core-install Pack** installed (required for Skills directory)
...
## Step 4: Generate Skill Index (If Using pai-core-install)
...
```bash
bun run $PAI_DIR/Tools/PaiArchitecture.ts log-upgrade "Installed pai-prompting-skill v1.0.0" pack
